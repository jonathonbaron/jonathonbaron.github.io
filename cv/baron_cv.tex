...
\end{tabular*} \\
\begin{tabular*}{7.1in}{l@{\extracolsep{\fill}}r}
Ph.D. candidate in Political Science, expected December 2018 & \\
...
\begin{tabular*}{7.1in}{p{6.925in}p{3cm}}
Stephen Herzog and Jonathon Baron. ``Public Support, Political Polarization, and the Nuclear Test Ban: Evidence from a New National Survey.'' In press at \textit{The Nonproliferation Review}.
\end{tabular*}
...
Evidence in Governance and Politics Standards Grant & 2017 - 2018 \\
Yale Program in Japanese Politics and Diplomacy Fellowship & 2015 - 2018 \\
...
\begin{tabular*}{7.1in}{p{6.925in}p{3cm}}
R, \LaTeX, Stata, Bash, basic Python, basic JavaScript, Platform LSF, Slurm Workload Manager \\
\end{tabular*}
...
\begin{tabular*}{7.1in}{l@{\extracolsep{\fill}}r}
Reviewer: {\it American Journal of Political Science} &\\
\end{tabular*}
