...
\vspace{0.13in}
\begin{tabular*}{7.1in}{p{6.925in}p{3cm}}
Jonathon Baron. ``Mass Attitudes and the Relationship Between Nuclear Power and Nuclear Weapons.'' Working paper available at \url{https://jonathonbaron.github.io/research/baron_mass_attitudes.pdf}.
\end{tabular*}
% \begin{tabular*}{7.1in}{p{6.925in}p{3cm}}
