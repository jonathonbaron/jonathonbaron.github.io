...
\begin{tabular*}{7.1in}{p{6.925in}p{3cm}}
Jonathon Baron and Stephen Herzog. ``Mass Attitudes and the Relationship Between Nuclear Power and Nuclear Weapons.'' Under review at \textit{Energy Research \& Social Sciences}.
\end{tabular*}

\vspace{0.13in}

\begin{tabular*}{7.1in}{p{6.925in}p{3cm}}
Stephen Herzog, Jonathon Baron, and Rebecca Davis Gibbons. ``Anti-Normative Messaging, Group Cues, and the Nuclear Ban Treaty.'' Under review at \textit{The Journal of Politics}.
\end{tabular*}
