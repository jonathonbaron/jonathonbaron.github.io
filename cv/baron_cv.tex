...
\begin{tabular*}{7.1in}{l@{\extracolsep{\fill}}r}
\textbf{The Chan Zuckerberg Initiative, Public Opinion and Survey Science} & Redwood City, CA \\
\end{tabular*} \\
\begin{tabular*}{7.1in}{l@{\extracolsep{\fill}}r}
Senior Quantitative Research Scientist, August 2022 - present & \\
\end{tabular*} \\
...
\end{tabular*} \\
\begin{tabular*}{7.1in}{l@{\extracolsep{\fill}}r}
Research Scientist, June 2020 - August 2022 & \\ %Public Interest Products Research Team
\end{tabular*} \\
...
\vspace{0.13in}
\begin{tabular*}{7.1in}{p{6.925in}p{3cm}}
Jonathon Baron. ``Dynamic Constraint and the Politics of Nuclear Attitudes.'' Working paper available at SocArXiv: \url{https://osf.io/preprints/socarxiv/gmdtb/}.
\end{tabular*}
