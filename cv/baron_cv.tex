...
\end{tabular*} \\
\begin{tabular*}{7.1in}{l@{\extracolsep{\fill}}r}
Ph.D. candidate in Political Science, May 2020 & \\
...
\begin{tabular*}{7.1in}{p{6.925in}p{3cm}}
Jonathon Baron and Stephen Herzog. ``Public opinion on nuclear energy and nuclear weapons: The attitudinal nexus in the United States.'' Forthcoming in \textit{Energy Research \& Social Science}.
\end{tabular*}
...
\vspace{0.13in}
\begin{tabular*}{7.1in}{p{6.925in}p{3cm}}
Working papers under review omitted to maintain anonymity.
\end{tabular*}
% \begin{tabular*}{7.1in}{p{6.925in}p{3cm}}
